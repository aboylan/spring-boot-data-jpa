...
public class ClienteController {
	...
	@Autowired
	private MessageSource meessageSource;
	...
	public String listar(@RequestParam(name = "page", defaultValue = "0") int page, Model model,
		...
		model.addAttribute("titulo", meessageSource.getMessage("text.cliente.listar.titulo", null, locale));
	...
	public String guardar(@Valid Cliente cliente, BindingResult result, Model model,
		...
		if (!foto.isEmpty()) {
			...
			flash.addFlashAttribute("info", "Hsa subido correctamente '" + uniqueFilename + "'");
